...
if (page.name=="createquestionnairev1") {
	write 'image::forms/createform.png[]'
	newLine()
}
...
if (page.name=="answertoquestionnaire") {
	write 'image::forms/answerformselect.png[]'
	newLine()
	write 'image::forms/answerform.png[]'
	newLine()
}
